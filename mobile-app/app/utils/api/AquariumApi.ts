...
const ENDPOINTS = {
  ...
  USER_AQUARIUMS: "/aquariums/list",
};

//region GET
export async function getAquariumById(
  aquariumId: string
): Promise<AquariumResponse> {
...
export async function getUserAquariums(): Promise<AquariumResponse[]> {
